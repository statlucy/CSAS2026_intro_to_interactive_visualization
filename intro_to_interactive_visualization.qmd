...
* Interned at Merck where I developed an R-Shiny application for the exploration and preliminary analysis of aggregate level datasets.
...
* Once your app works locally, you can share it online
* One option is shinyapps.io
  * Free hosting service by Posit
* Posit Connect / Shiny Server
  * More advanced / institutional hosting (more common for companies)
  * Used by companies and universities
  * Requires server setup (Linux, admin access)
